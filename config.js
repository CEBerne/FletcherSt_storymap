var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            website: '', 
            description: 'In 1937, Strawberry Mansion was redlined by the Home Owner’s Loan Corporation, which described the neighborhood as having a "Negro concentration". (Redlining is the act of denying residents access to home loans and mortgages based on perceived financial risk). As a result, it was subjected to white flight. Shortly thereafter, the black population ’’...grew 50 percent by 1960, followed by a rapid decline over the subsequent 20 years to a lower level than any time during the previous five decades…thus indicates an anomalous situation of sudden, severe crowding followed by drastic population loss’’ (Bartelt & Leon, 1986). This led to a proliferation of abandoned lots and municipal neglect, as shown in the photo above. This building, at 2509 Sedgley Ave (Owens, 1972), was around the corner from Fletcher Street. In the 1970s, the horse stable at 2603 W Fletcher Street (red square circled in purple on the map) was owned by Bessie Hellner, according to property deeds from City Hall’s Department of Records. In a recent WHYY interview on the black cowboy, the author mentions another black-run stable from the early 1980s. Called ‘The Hole in the Wall’ it was once located at Cecil B. Moore Ave and W. Glenwood Ave, where Ellis Ferrell boarded his horses (Crimmins, 2024). This need to find available space for horses is what led many black riders to seek refuge in Philadelphia’s Park system, including Fairmount and Northeast Philly’s Pennypack Park.',
            location: {
                center: [-75.17720, 39.98982],
                zoom: 17.6,
                pitch: 0,
