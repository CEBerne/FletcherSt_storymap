var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: 'This two-story red brick house, located at 2613 W Fletcher Street, appeared on fire insurance maps as of 1888. It currently sits against property owned by the Fletcher Street Urban Riding Club (2607-11 W Fletcher St). In 1923, when North Philadelphia was filled with horse stables, Horace Lederman purchased the deed to this residence. A Jewish “teamster”, Horace and his family remained on the street while it was being red lined in the 1930s. Charlie, a black octogenarian, remembers growing up under Horace’s care: learning to ride his first horse on Fletcher Street in the 1940s. Despite Jim Crow laws and the struggle for Civil Rights, Mr. Lederman continued to lend his horses to local children, regardless of racial tension that existed in the country at that time. It is partially due to Horace’s legacy, and the tradition of keeping stables on the block throughout the mid-20th century, that horse stables still exist on the street today.',
            location: {
                center: [-75.17919, 39.99034],
                zoom: 17.1,
                pitch: 0,
        ...
        },
        {
            ...
            website: '', 
            description: 'In 1937, Strawberry Mansion was redlined by the Home Owner’s Loan Corporation, which described the neighborhood having a ’Negro concentration’. Redlining is the act of denying residents access to home loans and mortgages based on perceived financial risk. As a result, it was subjected to white flight. Shortly thereafter, the black population ’...grew 50 percent by 1960, followed by a rapid decline over the subsequent 20 years to a lower level than any time during the previous five decades…thus indicates an anomalous situation of sudden, severe crowding followed by drastic population loss’ (Bartelt & Leon, 1986). This led to a proliferation of abandoned lots and municipal neglect, as shown in the photo above. The building above, at 2509 Sedgley Ave (Owens, 1972), was around the corner from Fletcher Street. In the 1970s, the horse stable at 2603 W Fletcher Street (red square circled in purple on the map) was owned by Bessie Hellner, according to property deeds from City Hall’s Department of Records. In a recent WHYY interview on ’the glory days of the Black cowboy’, the author mentions another black-run stable from the early 1980s. Called ‘The Hole in the Wall’ it was once located at Cecil B. Moore Ave and W. Glenwood Ave, where Ellis Ferrell boarded his horses (Crimmins, 2024). This need to find available space for horses is what led many black riders to seek refuge in Philadelphia’s Park system, including Fairmount and Northeast Philly’s Pennypack Park.',
            location: {
                center: [-75.17720, 39.98982],
                zoom: 17.6,
                pitch: 0,
        ...
        },
        {
        ...
        },
         {
            ...
            image: '',
            website: '', 
            description: '<iframe src="https://drive.google.com/file/d/1pMBVU9359srmuA5073mPrl3mzkCnH5Lu/preview" width="100%" height="380xp" allow="autoplay"></iframe><br><br>Losing the pasture was a massive blow for both humans and horses on Fletcher Street. Against the backdrop of the pandemic and the summer of Black Lives Matter, men and equines soldiered on. After lengthy negotiations between the Fletcher Street Urban Riding Club and the city, Councilman Darrell Clarke delivered on his promise to provide new grazing land for the organization. The Cliffs, a new stable with plenty of space in Fairmount Park, was built and gifted to the club on November 21st, 2023. As depicted on the map, their new barn is located just on the other side of the railroad tracks at 33rd Street, where Ellis used to run the Western Wranglers in Brewerytown. Since the Fletcher Street Urban Riding Club owns the 2607-11 lot on Fletcher Street, they still have stables there. The Cliffs, however, are on lease from the city. The club is still negotiating an official move with city administrators.',
            location: {
        ...
        },
         {
            ...
            image: '',
            website: '', 
            description: '<iframe src="https://drive.google.com/file/d/1yzBQxLucM1uukhTxUfsDhNzgx4GhzTtY/preview" width="100%" height="420" allow="autoplay"></iframe><br><br>On a gorgeous day in early November 2024, members of the Fletcher Street Urban Riding Club made a special visit to pay tribute to the Fletcher family grave site. Previously unaware that their namesake were resting nearby, they rode to pay tribute to the family who may be the primary reason horse culture has remained omnipresent on the block for nearly two-hundred years. Enjoy the video to experience this full-circle moment.',
            location: {
        ...
        },
        {
            ...
            image: '',
            website: '', 
            description: 'None of this would have been possible without the talent and endless patience of Felipe Valdez, GIS Specialist at Temple University’s Library. Thank you for being my co-pilot. Additional thanks to: Alex Wermer-Colan, Michael Kuetemeyer, Jasmine Clark, Jessica Braum, Max, Sree, Victoria Sarmiento Giraldo, the entire LCDSS staff, Ann Greene, Jacob Shell, El Dog Ferrell, Darrin Ferrell, Choo-Choo Charlie, Ron Tarver, Rick Gerrity, Jimmie Hooks, Bertha Felder, all the FSURC board members, Layla A. Jones, Darrell L. Clarke, Horace Lederman’s family, the Fletcher family estate, City Archive staff members Theresa Condon & Josh Blay, Free Library Map Collection archivists Megan MacCall & Grace Diliberto, Fairmount Park Historic Archivist Theresa Stuhlman, Program Coordinator Kat Bleiweiss at Laurel Hill East Cemetery, archival librarians at The Library Company, archival librarians at Temple’s Urban Archives, Department of Records staff at City Hall, and to Christopher for his support. I also want to acknowledge the other black horsemen and women in Philadelphia who continue to uphold the legacy of black stables across the city. My hope is that this project expands to include your contributions to the story of horses in Philadelphia and beyond.',
            location: {
                center: [-75.17919, 39.99034],
                zoom: 17.1,
                pitch: 0,
