var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            website: '', 
            description: 'Due to Strawberry Mansion being red lined in the 1930s, then subjected to white flight, followed by a boom of black residents, the population of the neighborhood “...grew 50 percent by 1960, followed by a rapid decline over the subsequent 20 years to a lower level than any time during the previous five decades…thus indicates an anomalous situation of sudden, severe crowding followed by drastic population loss" (Bartelt & Leon, 1986). This drop in population led to a proliferation of abandoned lots and municipal neglect, as shown in the photo above of a building located at 2509 Sedgley Ave (Owens, 1972), around the corner from Fletcher Street. In the 1970s, the sole horse stable at 2603 W Fletcher Street (red square circled in purple on the map) was owned by Bessie Hellner, according to property deeds from City Hall’s Department of Records. In a recent WHYY article on ‘the glory days of the Black cowboy’, the author mentions another black-run stable from the early 1980s called ‘The Hole in the Wall’ once located at Cecil B. Moore Ave and W. Glenwood Ave, where Ellis Ferrell boarded some of his equines (Crimmins, 2024). This need to find available space for horses is what led many black riders to seek refuge in Philadelphia’s Park system, including Fairmount and Northeast Philly’s Pennypack Park.',
            location: {
                center: [-75.17720, 39.98982],
                zoom: 17.6,
                pitch: 0,
